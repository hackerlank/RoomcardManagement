 ...
 */
var AccountSaleScene = (function (_super) {
    __extends(AccountSaleScene, _super);
    function AccountSaleScene() {
        _super.call(this);
        this.skinName = "AccountSaleSceneSkin";
        this.id = SceneType.account_sale;
    }
    var d = __define,c=AccountSaleScene,p=c.prototype;
    ...
    return AccountSaleScene;
}(BaseScene));
egret.registerClass(AccountSaleScene,'AccountSaleScene');
